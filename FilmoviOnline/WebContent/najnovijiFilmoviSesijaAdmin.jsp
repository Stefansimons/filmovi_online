...
if(admin!=null){
	...
	ArrayList<SearchedFilm> najnoviji=(ArrayList)sesija.getAttribute("najnoviji");
%>
			...
			<div class="container-fluid">
				<div class="col-md-9">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="Film?akcija=najnoviji">Najnoviji filmovi</a></li>
			...
			<div class="row content">
				...
				<div class="col-sm-10 text-center ">
					<div class="col-sm-12 text-center ">
						<h1 class="h2">Najnoviji filmovi</h1>

					</div>
					<div class="col-sm-12 text-center">
					<% if(najnoviji!=null && najnoviji.size()>0){ 
						for(SearchedFilm f:najnoviji){
					%>
						<div class="col-sm-3">
