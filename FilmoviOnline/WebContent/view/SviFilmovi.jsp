		...
		<nav class="navbar navbar-inverse navbar-default">
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav">
					...
					<li ><a href="UnosFilmova.jsp" >Unos filmova</a></li>
					<li class="active"><a href="SviFilmovi.jsp">Svi filmovi</a></li>
					<li ><a href="UnosKategorija.jsp">Unos Kategorija</a></li>
					<li><a href="IzmenaKategorija.jsp">Sve kategorije </a></li>
