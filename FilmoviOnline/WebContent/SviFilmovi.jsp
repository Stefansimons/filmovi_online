...
if(admin!=null){
	...
	ArrayList<Film> lf=(ArrayList)sesija.getAttribute("filmovi");
	...
	<div class="container-fluid">
			...
			<div class="container-fluid">
				<div class="col-md-9">
					<ul class="nav navbar-nav">
						...
						<li  class="active"><a href="Admin?akcija=filmovi">Svi filmovi</a></li>
		...
		<div class="container-fluid text-center">
			<div class="row " style="background: grey;color: black">
				<div class="col-md-3">
				<h2 style="color: red;">${succmsg}</h2><!-- USPESNA PROMENA FILMA -->
				</div>
				<div class="col-md-6" >
					<br><br>
					<table class="table table-striped table-bordered" style="text-align: left;background-color: white;"  >
						...
						<tr >
							<th style="text-align: center;">Naslov filma</th>
						...
						<tr >
							<td><%=f.getNaziv() %></td>
<%-- 						<td><a href="Admin?akcija=izmenaFilma&id_v=<%=f.getIdVidea()%>"  style="color: red">Izmeni</a></td>
 --%>						<td><a href="Admin?akcija=brisanjeFilma&id_v=<%=f.getIdVidea()%>"  style="color: blue">Obrisi</a></td>
						</tr>
						<%}}else { %>
						<tr >
							<td colspan="3">${msg }</td>
